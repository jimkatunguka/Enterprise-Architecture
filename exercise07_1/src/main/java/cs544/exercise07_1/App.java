    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Query query = session.createQuery(
                    "select f from Flight f join f.airplane a where a.capacity > :cap");
            query.setParameter("cap", 500);
            List<Flight> flights1 = query.list();
        ...
        try {
            ...
            System.out.println(".......................................................................");
            Query query = session.createQuery(
                   "select a from Airline a join a.flights f join f.airplane p where p.model like :mod"
            );
          query.setParameter("mod", "A380");
            List<Airline> airlines1 = query.list();

            System.out.println("Airlines:");
            for (Airline airline : airlines1) {
        ...
        try {
            ...
            Query query = session.createQuery(
                    "select f from Flight f join f.airplane p join f.airline a where p.model like :mod and a.name != :nam"
            );
            query.setParameter("mod", "%747%");
            query.setParameter("nam", "Star Alliance");
        ...
        try {
            ...
            Query query = session.createQuery(
                    "select f from Flight f where f.departureDate = :dat and hour(f.departureTime) < hour(:tim)"
            );

            DateFormat df = DateFormat.getDateInstance(DateFormat.SHORT, Locale.US);
            DateFormat dtf = DateFormat.getTimeInstance(DateFormat.SHORT, Locale.US);
            query.setParameter("dat", df.parse("08/07/2009"));
            query.setParameter("tim", dtf.parse("12:00 pm"));

            List<Flight> flights2 = query.list();
